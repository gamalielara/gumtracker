import PountingFace from "../../../assets/emoji/Pouting Face.svg";
...
import GrinSquintingFace from "../../../assets/emoji/Grinning Squinting Face.svg";
import PartyFace from "../../../assets/emoji/Partying Face.svg";

export const BAD_MOODS_RANGE = {
  1: PountingFace,
  2: LoudlyCrying,
  3: PerseveringFace,
  4: SlightlyFrowning,
